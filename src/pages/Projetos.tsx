...
const ProjectCard = ({
  ...
  <div className="rounded-lg shadow-lg overflow-hidden transform  transition duration-300 hover:scale-105 border border-gray-600 border-r-1 border:opacity-90">
    ...
    <div className="p-6 py-2">
      ...
      <div className="flex flex-wrap gap-2">
        {technologies.map((tech) => (
          <span
            key={tech}
            className="px-3 py-1 bg-blue-100 dark:bg-blue-950 text-blue-800 dark:text-white rounded-full text-sm"
          >
            {tech}
          </span>
        ))}
      ...
      <div className="flex flex-wrap justify-center w-full py-8">
        <a
          href={link}
          className="inline-block min-w-[100px] bg-blue-950 hover:bg-blue-900 text-white font-medium py-2 px-16 rounded-lg transition-colors"
        >
          Ver Projeto
        </a>
      </div>
